...
class PlayScene(Scene):
    ...
    def do_create(self):
        ...
        self.pl_entity, self.pl_tr, self.pl_v, self.pl_tg, self.pl_cs = create_player(self.ecs_world)
        self.bullet = create_player_bullet(self.ecs_world,self.pl_tr.pos,self.pl_cs.area.size,self.pl_entity)
